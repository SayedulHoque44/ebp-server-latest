...
class QueryBuilder {
        ...
        rangeFields.forEach(rangeField => {
            ...
            if (["gte", "lte"].includes(operator)) {
                if (!filterQuery[field])
                    filterQuery[field] = {};
                filterQuery[field][`$${operator}`] = new Date(queryObj[rangeField]);
    ...
    sort() {
        var _a, _b, _c;
        const sort = ((_c = (_b = (_a = this === null || this === void 0 ? void 0 : this.query) === null || _a === void 0 ? void 0 : _a.sort) === null || _b === void 0 ? void 0 : _b.split(",")) === null || _c === void 0 ? void 0 : _c.join(" ")) || "createdAt"; //"-createdAt"
